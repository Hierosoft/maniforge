 ...
 */
  ...
  // ^ Based on approximate stopwatch readings, the Replicator 2X bed heats
...
// LCD Print Progress options
  ...
  // ^ recommended for BTT TFT (See <https://github.com/bigtreetech/BIGTREETECH-TouchScreenFirmware>)
  ...
  // ^ ONBOARD recommended for BTT TFT (See <https://github.com/bigtreetech/BIGTREETECH-TouchScreenFirmware>)
...
//
  ...
  //#define TOUCH_UI_USE_UTF8
    ...
    #define TOUCH_UI_UTF8_WESTERN_CHARSET
      ...
      //#define TOUCH_UI_UTF8_MATHEMATICS   // ± x ÷
...
// ^ 4 recommended for BTT TFT (See <https://github.com/bigtreetech/BIGTREETECH-TouchScreenFirmware>)
