...
#define TEMP_SENSOR_1 11 // 2ND NOZZLE
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 88.888889, 88.888889, 400, 91.46125 }
/*
Extrusion:
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -36, 0, 0 } // This was set for a hand-machined cooling block (z=+3.65 when not deployed; 6.07 using dial and 0.1mm feeler gauge), but may be or may need to be updated for FlexionHT
...
//#define AUTO_BED_LEVELING_BILINEAR // specified in the BLTouch Smart V3.1 manual but UBL supercedes it and MESH_BED_LEVELING
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define G26_MESH_VALIDATION
    ...
    #define MESH_TEST_BED_TEMP      63    // (°C) Default bed temperature for G26.
